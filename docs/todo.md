...
- [ ] **(Pinned / deferred)** Synthesize a cumulative battery energy counter for the `battery` driver so Homey's Battery + native Home accounting work. **Tracked in [#10](https://github.com/andersdissing/com.aiswei.solplanet/issues/10).**
